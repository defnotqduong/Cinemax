        ...
        <div class="col-span-5">
            ...
            <div class="w-[90%]">
                ...
                <div class="mb-8 flex items-center justify-start gap-3">
                    <button
                        class="pl-4 pr-2 py-1 h-10 min-w-[150px] bg-secondary rounded-full text-white text-base font-semibold hover:bg-secondaryHover transiton-all duration-[300ms]"
                    >
                        <router-link
                            :to="{
                                name: 'home-watching',
                        ...
                        >
                            <span>Xem phim</span>
                            <span class="px-3 py-[6px] rounded-full bg-black bg-opacity-20">
                    ...
                    >
                        ...
                        <span class="px-3 py-[6px] rounded-full bg-white bg-opacity-10">
