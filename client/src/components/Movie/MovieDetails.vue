    ...
    <div class="mx-14 grid grid-cols-4 gap-10">
        ...
        <div class="col-span-3">
            ...
            <div>
                ...
                <ul
                    class="mt-6 grid grid-cols-2 gap-x-14 gap-y-4 text-secondary"
                >
                    <li
                ...
                <div class="mt-10 flex items-center justify-start gap-4">
                    <button
                        class="px-6 py-2 relative flex items-center justify-center gap-2 rounded bg-primary-alpha text-white text-lg font-semibold"
                    >
                        <svg
