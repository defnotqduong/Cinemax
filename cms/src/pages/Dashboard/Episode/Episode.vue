<template>
    <div class="py-20 mr-8">
        ...
        <div v-if="!loading" class="overflow-x-auto mt-8">
            <h4 class="font-bold text-xl text-white mb-4 ml-4">Phim: {{ title }}</h4>
            <table class="table">
                <!-- head -->
                <thead>
                    <tr>
                ...
                <tbody>
                    <tr v-for="ep in eps" :key="ep.id">
                        <td>
                            <p class="line-clamp-3">{{ ep.episode }}</p>
                        </td>
                            ...
                            <div class="flex items-center justify-center gap-3">
                                ...
                                <label
                                    ...
                                    ><svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="0 0 24 24" fill="none">
                                        ...
                                        /></svg
                                ></label>
                                <input type="checkbox" :id="'modal_delete_' + ep.id" class="modal-toggle" />
