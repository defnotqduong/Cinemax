<template>
    <div class="py-20 px-10">
        <h3 class="text-2xl font-bold mb-10">Chỉnh sửa thể loại:</h3>
        ...
        <form v-if="!loading" class="w-[50%] mx-auto" @submit.prevent="edit">
            <label for="title" class="block mb-6">
                <div class="text-lg font-semibold mb-3">Tên thể loại:</div>
...
import { editGenre, getGenre } from '../../../webServices/genreService'
