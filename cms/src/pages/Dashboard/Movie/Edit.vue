<template>
    <div class="py-20 px-10">
        <h3 class="text-2xl font-bold mb-10">Chỉnh sửa Phim:</h3>
        ...
        <form v-if="!loading" class="w-[100%] mx-auto px-8 grid grid-cols-2 gap-x-6" @submit.prevent="edit">
            <div class="col-span-2 grid grid-cols-3">
                ...
                <div class="block mb-6 col-span-2">
                    ...
                    <label
                        ...
                        for="poster"
                    >
                        <img ref="fileInput" :src="posterUrl ? posterUrl : poster" alt="Poster" class="w-full h-full object-cover object-center" />
                    </label>
...
export default defineComponent({
    ...
    methods: {
        async loadData() {
            ...
            const [categoryData, genreData, countryData, movieData] = await Promise.all([
                getInitialCategory(),
                getInitialGenre(),
                getInitialCountry(),
                getMovie(slug)
